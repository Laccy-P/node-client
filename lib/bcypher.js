 ...
 */
const Blockcy = function(coin, chain, token) {
	this.coin = coin;
	this.chain = chain;
	this.token = token;
};
 ...
 * @method listWallets
 */
Blockcy.prototype.listWallets = function() {
 ...
 */
Blockcy.prototype.listHDWallets = function() {
 ...
 * @method getUnTXs
 */
Blockcy.prototype.getUnTXs = function() {
 ...
 * @method listPayFwds
 */
Blockcy.prototype.listPayFwds = function() {
